...
export default function UpdateInfoPage({ handleClickSave }: UpdateInfoPage) {
  ...
  let InfoUser = () => {
    return (
      <>
        <div className="ml-5 my-5 text-2xl font-bold text-blue-500  ">
          * Thông tin cá nhân
        </div>
        <div className="grid grid-cols-3 gap-x-6 gap-y-2  px-5 ">
          {/* Họ và tên */}
          ...
          >
            <p className="w-[280px] pl-[15px] font-semibold">Họ và tên :</p>
            <p>{userData.name}</p>
          </div>
          ...
          {typePerson(type) && (
            <div
              ...
              style={{ backgroundColor: "rgb(243, 244, 246)" }}
            >
              <p className="w-[280px] pl-[15px] font-semibold">
                Mã số sinh viên :
              </p>
              <p>{userData.id}</p>
            </div>
          ...
          >
            ...
            <input
              ...
              className="w-[150px] pr-3 border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#ff9000] pl-4 py-2 rounded-md shadow-sm"
            />
          </div>
          {/* Số điện thoại */}
          <div
          ...
          >
            ...
            <input
              ...
              onChange={handleChange}
              className="w-[300px]  pl-4 py-2 rounded-md border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#ff9000] shadow-sm"
  ...
  let InfoDependent = () => {
    return (
      <>
        ...
        <div className="grid grid-cols-3 gap-x-6 gap-y-2 mt-3 px-5">
          {/* Tên người thân */}
          <div
            className="flex items-center mb-4 h-[60px] pr-5"
            style={{ backgroundColor: "rgb(243, 244, 246)" }}
          >
            <p className="w-[280px] pl-[15px] font-semibold font-semibold pr-5">
              Tên người thân
            </p>
            <input
              type="text"
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.forEach((value, key) => {
      formDataObject[key] = value as string; // Lưu dữ liệu dưới dạng object
    });

    console.log("Dữ liệu từ form: ", formDataObject);
    handleClickSave();
  };
  let ButtonSubmit = () => {
    return (
    ...
    <div className="mt-8 mb-[100px]">
      <main className="relative ">
        ...
        <form
          ...
          className="mt-5 border-2 border-[#2f303342] px-0 rounded-lg pt-5 h-[calc(100vh)] text-base "
        >
          <InfoUser />
          <InfoDependent />
          <ButtonSubmit />
