...
function CoursePage() {
  ...
  const Title = ({ title, onclick, active }: TitleProps) => {
    return (
      <div className="flex justify-center mt-6">
        <div
          className="cursor-pointer pl-2 text-[24px] font-semibold w-[900px] flex items-center text-[#0388b4] h-[50px] relative border border-gray-300 rounded-2xl bg-white select-none"
          onClick={onclick}
        >
  ...
  let File = ({ file }: { file: FileIN }) => {
    return (
      <div className="flex justify-center mt-4 ml-[40px]">
        <div className="px-2 py-2 bg-white text-[18px] font-medium w-[860px] flex items-center min-h-[50px] relative border border-gray-300 rounded-xl">
  ...
  let Description = ({ notify }: { notify: string }) => {
    return (
      <div className="flex justify-center mt-3 ml-[40px]">
        <div className="p-4 pt-2 bg-gray-200 text-[18px] font-medium w-[860px] flex items-center text-black min-h-[50px] relative border border-gray-300 rounded-xl">
